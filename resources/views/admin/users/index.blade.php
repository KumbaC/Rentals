            ...
            <table class="table table-separate table-head-custom table-checkable" id="users">
                <thead>
                    <tr>
                        ...
                        <th class="mobile tablet desktop">Nombre</th>
                        <th class="mobile tablet desktop">Email</th>
                        <th class="mobile tablet desktop">Is Admin</th>
                        <th class="mobile tablet desktop">Position</th>
                        <th class="mobile tablet desktop">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.users.edit', Crypt::encrypt($user->id)) }}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                    <span class="svg-icon svg-icon-md">
                                       <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <a href="#" data-toggle="modal" data-target="#kt_modal_delete{{ $user->id }}" class="btn btn-sm btn-clean btn-icon" title="Delete" id="delete_btn">
                                    <span class="svg-icon svg-icon-md">
                                       <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                             <rect x="0" y="0" width="24" height="24"></rect>
    ...
    @foreach($users as $key => $value)
		<div class="modal fade" id="kt_modal_delete{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				{!! Form::open(['route' => ['admin.users.destroy', encrypt($value->id)], 'method' => 'DELETE','id'=>"form_eliminar"]) !!}
					{{ csrf_field() }}
