    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('admin.users.index') }}" class="btn btn-primary font-weight-bolder">
        ...
        {!! Form::open(['route' => ['admin.users.store'], 'method' => 'POST', 'id' => 'add_user']) !!}
			{{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-6">
                        <label class="col-form-label">Name <span class="asterisk-required">*</span></label>
                        {{ Form::text('name', null, array('class'=>'form-control', 'id'=>'name')) }}
                    </div>
                    <div class="form-group col-6">
                        <label class="col-form-label">Email <span class="asterisk-required">*</span></label>
                ...
                <div class="form-group col-12">
                    <label class="col-form-label" for="categories">Position <span class="asterisk-required">*</span></label>
                    <select class="form-control select2" id="position" name="position_id">
                            @foreach ($position as $positions)
                            <option value="{{$positions->id}}">
                                {{$positions->name}}</option>
                            @endforeach
                    </select>
                </div>
               ...
               <div class="form-group col-6">
                {{ Form::radio('admin', 1, array('class'=>'form-control', 'id'=>'radio')) }}
                <label class="col-form-label">Administrador </label>

                {{ Form::radio('admin', 0, array('class'=>'form-control', 'id'=>'radio')) }}
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-6">
                        <label class="col-form-label">Password <span class="asterisk-required">*</span></label>
                    ...
                    @enderror
                    <div class="form-group col-6">
                        <label class="col-form-label">Confirm Password <span class="asterisk-required">*</span></label>
                        {{ Form::password('password_confirmation', array('class'=>'form-control', 'id'=>'password-confirm', 'required')) }}
                    </div>
