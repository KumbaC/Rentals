...
@section('content')
    ...
    <div class="card card-custom">
        ...
        {!! Form::model($working,['route' => ['admin.working.update', Crypt::encrypt($working->id)], 'method' => 'PUT', 'id' => 'add_working']) !!}
			{{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-12">
                        <label class="col-form-label" for="users">Users | Empleados <span class="asterisk-required">*</span></label>
                        <select class="form-control select2" id="users" name="user_id">
                                @foreach ($user as $users)
                                <option value="{{$users->id}}"
                                    @foreach ($user_selected as $selected)
                                    @if($users->id == $selected->id) selected @endif
                                    @endforeach>
                                    {{$users->name}}</option>
                                @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        {!! Form::time('lunch_time', null, array('class'=>'form-control', 'id'=>'lunch_time')) !!}
                    </div>
                    <div class="form-group col-4">
                        <label class="col-form-label">Back | Regreso del almuerzo<span class="asterisk-required">*</span></label>
                        {!! Form::time('back_lunch', null, array('class'=>'form-control', 'id'=>'back_lunch')) !!}
                    </div>
                </div>
                ...
                <div class="row break" style="display: none;">
                    ...
                    <div class="form-group col-6 break">
                        ...
                        {!! Form::time('break_time', null, array('class'=>'form-control', 'id'=>'break_time')) !!}
                    </div>

                    <div class="form-group col-6 break">
                        <label class="col-form-label">Back | Return of the first break<span class="asterisk-required">*</span></label>
                        {!! Form::time('back_break', null, array('class'=>'form-control', 'id'=>'back_break')) !!}
                    </div>
                ...
                <div class="row break2" style="display: none;">
                    ...
                    <div class="form-group col-6">
                        ...
                        {!! Form::time('time_break_two', null, array('class'=>'form-control', 'id'=>'time_break_two')) !!}
                    </div>


                    <div class="form-group col-6">
                        <label class="col-form-label">Back | Return of the second break<span class="asterisk-required">*</span></label>
                        {!! Form::time('back_break_two', null, array('class'=>'form-control', 'id'=>'back_break_two')) !!}
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        {!! Form::datetimeLocal('out', null, array('class'=>'form-control', 'id'=>'out')) !!}
                    </div>
                </div>
...
$(document).ready(function() {
  if ($('input[name="break"]').prop('checked') && $('input[name="break"]').val() == 1) {
    $('.break').show();
  } else {
    $('.break').hide();
  }

  if ($('input[name="break_two"]').prop('checked') && $('input[name="break_two"]').val() == 1) {
    $('.break2').show();
  } else {
    $('.break2').hide();
  }
