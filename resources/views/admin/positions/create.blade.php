...
@section('content')
    ...
    <div class="card card-custom">
        ...
        {!! Form::open(['route' => ['admin.positions.store'], 'method' => 'POST', 'id' => 'add_positions']) !!}
			{{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        {!! Form::number('first_payment', '', array('class'=>'form-control', 'id'=>'first_payment', 'min'=>1, 'max'=>31)) !!}
                    </div>
                    <div class="form-group col-6">
                        <label class="col-form-label">Second Payment <span class="asterisk-required">*</span></label>
                        {!! Form::number('second_payment', '', array('class'=>'form-control', 'id'=>'second_payment', 'min'=>1, 'max'=>31)) !!}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        {!! Form::time('start_time', '', array('class'=>'form-control', 'id'=>'name')) !!}
                    </div>
                    <div class="form-group col-6">
                        <label class="col-form-label">End time <span class="asterisk-required">*</span></label>
                        {!! Form::time('end_time', '', array('class'=>'form-control', 'id'=>'name')) !!}
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        {!! Form::textarea('description', '', array('class'=>'form-control', 'id'=>'description', 'size' => '50x4')) !!}
                    </div>
                </div>
            </div>
